...
create table if not exists public.deals (
  ...
  comment_signal_score integer not null default 0,
  positive_comment_signals integer not null default 0,
  negative_comment_signals integer not null default 0,
...
alter table public.deals
  ...
  add column if not exists comment_signal_score integer not null default 0,
  add column if not exists positive_comment_signals integer not null default 0,
  add column if not exists negative_comment_signals integer not null default 0,
